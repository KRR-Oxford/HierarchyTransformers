...
class HyperbolicProjection(nn.Module):
    """Projection (from Euclidean to Hyperbolic) layer modified from the models.Dense.
    ...
    def __repr__(self):
        return "HyperbolicProjection({})".format(self.get_config_dict())
    ...
    def load(input_path):
        ...
        model = HyperbolicProjection(**config)
