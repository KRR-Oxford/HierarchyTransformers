...
class PretrainedMaskFillEvaluator:
    ...
    def __call__(
        ...
        for threshold in tqdm(range(start, end), desc="Thresholding"):
            ...
            results = evaluate_by_threshold(val_scores, val_labels, threshold, False)
        ...
        test_results = evaluate_by_threshold(test_scores, test_labels, best_val_results["threshold"], False)
...
class PretrainedSentenceSimilarityEvaluator:
    """Evaluator for pre-trained language models.
